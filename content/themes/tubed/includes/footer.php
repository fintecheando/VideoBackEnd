	...
	<footer class="col-md-offset-2 col-md-10 right-content-10">
				...
				<div class="col-md-4">
					...
					<p><?= ThemeHelper::getThemeSetting(@$theme_settings->footer_description, 'ScotiaBank is your Video Subscription Platform. Add unlimited videos, posts, and pages to your subscription site. Earn re-curring revenue and require users to subscribe to access premium content on your website.') ?></p>
	  ...
	  $('document').ready(function(){
	    ...
	    <?php if(Session::get('note') != '' && Session::get('note_type') != ''): ?>
	    	...
	    	<?php if(Session::get('note_type') != '' && Session::get('note_type') == 'error'): ?>
	    		$.growl({ icon: "fa fa-times-circle-o", message: ' <?= str_replace("'", "\\'", Session::get("note")) ?>' }, { type: "danger" });
	    	<?php endif; ?>
