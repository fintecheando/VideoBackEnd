...
<div class="col-md-10 col-md-offset-2 right-content-10" style="padding-left:0px; padding-right:0px;">
	...
	<div class="container-fluid">
		...
		<div id="left_content">						
			...
			<div class="video-details-container" style="background:none; color:#777"><?= $details ?></div>
			<br />
			<div class="clear"></div>
	...
	<script type="text/javascript">
        ...
        var disqus_shortname = 'svideo'; // required: replace example with your forum shortname
	...
	<script type="text/javascript">
		...
		function resetEpisodeListHeight(){
			$('#episodes').css('min-height', $('#video_left').height()-120);
			$('#episodes').css('max-height', $('#video_left').height()-120);
		}
